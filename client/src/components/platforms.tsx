      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          <motion.div
            ...
            className="flex flex-col justify-between gap-6 rounded-2xl border-2 border-[#3a6aa0] bg-white p-6 md:p-8"
          >
            {/* HTS */}
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[#f0f7ff]">
                  <Monitor className="h-6 w-6 text-[#3a6aa0]" />
                </div>
                <div>
                  <div className="flex items-center gap-2">
                    <h3 className="font-bold text-slate-900">HTS</h3>
                    <span className="rounded-full bg-[#3a6aa0] px-2 py-0.5 text-xs font-bold text-white">추천</span>
                  </div>
                  <p className="mt-0.5 break-keep text-xs text-slate-400">Windows · 데스크탑</p>
                </div>
              </div>
              <a
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#3a6aa0] px-5 py-2.5 text-sm font-bold text-white transition-colors hover:bg-[#315b8b] sm:w-auto sm:shrink-0"
              >
          ...
          <motion.div
            ...
            className="flex flex-col justify-center gap-6 rounded-2xl border border-slate-200 bg-white p-6 md:p-8"
          >
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[#f0f7ff]">
