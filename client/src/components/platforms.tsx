      ...
      <div className="container text-center px-4 md:px-6">
        ...
        <Tabs defaultValue="desktop" className="w-full max-w-5xl mx-auto">
          ...
          <TabsContent value="desktop" className="mt-0">
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12 text-left">
              <div className="flex-1 space-y-4 md:space-y-6">
                <h3 className="text-xl md:text-2xl font-bold text-secondary">MT5 데스크탑</h3>
                <p className="text-gray-300 leading-relaxed text-sm md:text-base">
                  MT5 플랫폼을 데스크톱이나 노트북에 직접 설치하면 플랫폼의 모든 기능을 이용할 수 있습니다. 
          ...
          <TabsContent value="mobile" className="mt-0">
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12 text-left">
              <div className="flex-1 space-y-4 md:space-y-6">
                <h3 className="text-xl md:text-2xl font-bold text-secondary">MT5 모바일</h3>
                <p className="text-gray-300 leading-relaxed text-sm md:text-base">
          ...
          <TabsContent value="web" className="mt-0">
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12 text-left">
              <div className="flex-1 space-y-4 md:space-y-6">
                <h3 className="text-xl md:text-2xl font-bold text-secondary">MT5 웹트레이더</h3>
                <p className="text-gray-300 leading-relaxed text-sm md:text-base">
