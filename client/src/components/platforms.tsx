      ...
      <div className="container text-center">
        ...
        <Tabs defaultValue="desktop" className="w-full max-w-5xl mx-auto">
          ...
          <TabsContent value="desktop" className="mt-0">
            <div className="flex flex-col md:flex-row items-center gap-12 text-left">
              <div className="flex-1 space-y-6">
                <h3 className="text-2xl font-bold text-secondary">MT5 데스크탑</h3>
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  ...
                  <Button variant="outline" className="border-white text-white hover:bg-white hover:text-primary rounded-full">Mac 다운로드</Button>
                </div>
              </div>
          ...
          <TabsContent value="web" className="mt-0">
            <div className="flex flex-col md:flex-row items-center gap-12 text-left">
              <div className="flex-1 space-y-6">
                <h3 className="text-2xl font-bold text-secondary">MT5 웹트레이더</h3>
                <p className="text-gray-300 leading-relaxed">
