...
export function Footer() {
  return (
    <footer className="bg-[#1a2a3a] text-white pt-12 md:pt-20 pb-8 md:pb-10 border-t border-slate-700">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center text-center mb-8 md:mb-12">
          ...
          <p className="text-slate-400 leading-relaxed max-w-md text-sm md:text-base px-4">
            SMART는 전 세계 트레이더들에게 프리미엄 거래 서비스를 제공하는 글로벌 온라인 트레이딩 파트너입니다.
          </p>
        </div>

        <div className="border-t border-slate-700 pt-6 md:pt-8 mt-6 md:mt-8 text-center flex flex-col justify-center items-center text-xs md:text-sm text-slate-500">
